...
public class WebController {
    ...
    @ModelAttribute("datosUsuarioDto")
    public DatosUsuarioDto retornarNuevoUsuario() {
    ...
    public String registrarCuentaDeUsuario(
            ...
            @Valid
            @ModelAttribute("datosUsuarioDto") DatosUsuarioDto datosUsuarioDto,
        ...
        usuarioService.GuardarUsuario(datosUsuarioDto);
