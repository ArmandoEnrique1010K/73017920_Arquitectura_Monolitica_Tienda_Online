...
public class AdminController {
    ...
    public String GuardarNuevaCategoria(
        ...
        logger.info("SE HA SUBIDO LA CATEGORIA " + categoriaDto);
    ...
    public String MostrarFormularioDeEditarCategoria(@PathVariable Long id_categoria, Model model) {
        ...
        model.addAttribute("categoriaDto", categoriaService.ObtenerCategoriaPorId(id_categoria));
    ...
    public String GuardarCategoriaEditada(
        ...
        categoriaService.CambiarNombreCategoria(id_categoria, categoriaDto);
    ...
    public String GuardarNuevaMarca(
            @Valid @ModelAttribute("marcaDto") MarcaDto marcaDto,
            BindingResult result) {
        ...
        logger.info("SE HA SUBIDO LA MARCA " + marcaDto);
    ...
    public String MostrarFormularioDeEditarMarca(@PathVariable Long id_marca, Model model) {
        ...
        model.addAttribute("marcaDto", marcaService.ObtenerMarcaPorId(id_marca));
    ...
    public String GuardarMarcaEditada(
        ...
        marcaService.CambiarNombreMarca(id_marca, marcaDto);
    ...
    public String ResturarMarca(@PathVariable Long id_marca) {
    ...
    public String ListarTodosLosProductosDelSistemaPorFiltros(
        ...
        Page<DatosProductoDto> datosProductoDto = productoService.PaginarProductosPorFiltrosDeBusqueda(categoriaId, marcaIds, minPrecio, maxPrecio, enOferta, palabraClave, pageRequest);
        PageRender<DatosProductoDto> pageRender = new PageRender<>("/admin/productos", datosProductoDto);

        // ATRIBUTO PARA LA LISTA DE TODOS LOS PRODUCTOS EN EL SISTEMA
        model.addAttribute("productos", datosProductoDto);
    ...
    public String GuardarNuevoProducto(
        ...
        ProductoDto productoGuardado = productoService.GuardarProducto(productoDto, imagenproducto_imagen);
        logger.info("SE HA GUARDADO EL PRODUCTO: " + productoGuardado);
...
// RUTA A LA PAGINA DE EDITAR UN PRODUCTO QUE EXISTE: http://localhost:8080/admin/productos/.../editar
    ...
    public String MostrarFormularioDeEditarProducto(
        ...
        model.addAttribute("productoDto", productoService.ObtenerProductoPorId(id_producto));
    ...
    public String GuardarProductoEditado(
        ...
        productoService.ActualizarProducto(id_producto, productoDto, imagenproducto_imagen);
    ...
    public String RestaurarProducto(@PathVariable Long id_producto) {
        productoService.RestaurarProducto(id_producto);
    ...
    public String ListarTodosLosProductosDelSistemaPorPalabraClave(
        ...
        // LLAMA AL SERVICIO PARA PAGINAR Y FILTRAR LOS PRODUCTOS
        Page<DatosProductoDto> datosProductoDto = productoService.PaginarProductosPorFiltrosDeBusqueda(categoriaId, marcaIds, minPrecio, maxPrecio, enOferta, palabraClave, pageRequest);
        PageRender<DatosProductoDto> pageRender = new PageRender<>("/productos/buscar", datosProductoDto);
