...
public class ProductoController {
 ...
 /*
    ...
    public String ListarTodosLosProductos(
        ...
        Page<VariosProductosDto> variosProductoDto = productoService.PaginarProductosHabilitadosPorFiltrosDeBusqueda(categoriaId, marcaIds, minPrecio, maxPrecio, enOferta, null, pageRequest);
        PageRender<VariosProductosDto> pageRender = new PageRender<>("", variosProductoDto);
    ...
    public String ListarTodosLosProductos(
        ...
        // Llama al servicio para paginar y filtrar los productos
        Page<VariosProductosDto> variosProductoDto = productoService.PaginarProductosHabilitadosPorFiltrosDeBusqueda(categoriaId, marcaIds, minPrecio, maxPrecio, enOferta, null, pageRequest);
        PageRender<VariosProductosDto> pageRender = new PageRender<>("/productos", variosProductoDto);
    ...
    public String ListarTodosLosProductosPorCategoria(
        ...
        CategoriaDto categoriaDto = categoriaService.ObtenerCategoriaPorNombre(categoriaNombre);
        model.addAttribute("categorias", categoriaService.ListarCategoriasByEstadoTrue());
        model.addAttribute("productos", productoService.ListarProductosHabilitadosPorFiltrosDeBusqueda(
                categoriaDto.getId_categoria(), marcaIds, minPrecio, maxPrecio, enOferta, null));
        ...
        logger.info("MOSTRANDO LOS TODOS LOS PRODUCTOS QUE CORRESPONDEN "
                + "A LA CATEGORIA: " + categoriaDto.getId_categoria()
 ...
 /*
    ...
    public String ListarTodosLosProductosPorCategoria(
        ...
        Pageable pageRequest = PageRequest.of(page, 10);
        // Llama al servicio para paginar y filtrar los productos
        Page<VariosProductosDto> variosProductoDto = productoService.PaginarProductosHabilitadosPorFiltrosDeBusqueda(categoriaDto.getId_categoria(), marcaIds, minPrecio, maxPrecio, enOferta, null, pageRequest);
        PageRender<VariosProductosDto> pageRender = new PageRender<>("", variosProductoDto);
        model.addAttribute("productos", variosProductoDto);
        model.addAttribute("page", pageRender);
        model.addAttribute("categorias", categoriaService.ListarCategoriasByEstadoTrue());
    ...
    public String ListarTodosLosProductosPorCategoria(
        ...
        // Llama al servicio para paginar y filtrar los productos
        Page<VariosProductosDto> variosProductoDto = productoService.PaginarProductosHabilitadosPorFiltrosDeBusqueda(categoriaDto.getId_categoria(), marcaIds, minPrecio, maxPrecio, enOferta, null, pageRequest);
        PageRender<VariosProductosDto> pageRender = new PageRender<>("/productos/{categoriaNombre}", variosProductoDto);
        model.addAttribute("productos", variosProductoDto);
        model.addAttribute("page", pageRender);
        model.addAttribute("categorias", categoriaService.ListarCategoriasByEstadoTrue());
        model.addAttribute("categoriaActual", categoriaService.ObtenerCategoriaPorNombre(categoriaNombre));
    ...
    public String ListarTodosLosProductosEnOferta(
        ...
        model.addAttribute("categorias", categoriaService.ListarCategoriasByEstadoTrue());
        model.addAttribute("productos", productoService.ListarProductosHabilitadosPorFiltrosDeBusqueda(
                categoriaId, marcaIds, minPrecio, maxPrecio, Boolean.TRUE, null));
        model.addAttribute("marcas", marcaService.ListarMarcasByEstadoTrue());
 ...
 /*
    ...
    public String ListarTodosLosProductosEnOferta(
        ...
        Pageable pageRequest = PageRequest.of(page, 10);
        // Llama al servicio para paginar y filtrar los productos
        Page<VariosProductosDto> variosProductoDto = productoService.PaginarProductosHabilitadosPorFiltrosDeBusqueda(categoriaId, marcaIds, minPrecio, maxPrecio, Boolean.TRUE, null, pageRequest);
        PageRender<VariosProductosDto> pageRender = new PageRender<>("", variosProductoDto);
        model.addAttribute("productos", variosProductoDto);
        model.addAttribute("page", pageRender);
        model.addAttribute("categorias", categoriaService.ListarCategoriasByEstadoTrue());
    ...
    public String ListarTodosLosProductosEnOferta(
        ...
        // Llama al servicio para paginar y filtrar los productos
        Page<VariosProductosDto> variosProductoDto = productoService.PaginarProductosHabilitadosPorFiltrosDeBusqueda(categoriaId, marcaIds, minPrecio, maxPrecio, Boolean.TRUE, null, pageRequest);
        PageRender<VariosProductosDto> pageRender = new PageRender<>("/productos/oferta", variosProductoDto);
    ...
    public String ListarElResultadoDeUnaBusquedaDeProductos(
        ...
        // LLAMA AL SERVICIO PARA PAGINAR Y FILTRAR LOS PRODUCTOS
        Page<VariosProductosDto> variosProductosDto = productoService.PaginarProductosHabilitadosPorFiltrosDeBusqueda(categoriaId, marcaIds, minPrecio, maxPrecio, enOferta, palabraClave, pageRequest);
        PageRender<VariosProductosDto> pageRender = new PageRender<>("/productos/buscar", variosProductosDto);

        // ATRIBUTO PARA LA LISTA DE TODOS LOS PRODUCTOS
        model.addAttribute("productos", variosProductosDto);
